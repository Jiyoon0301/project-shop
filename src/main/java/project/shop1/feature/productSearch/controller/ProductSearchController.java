package project.shop1.feature.productSearch.controller;
...
public class ProductSearchController {
    ...
    /* 상품 검색 - 검색어, 카테고리 */
    @PostMapping("/findByKeywordAndCategory") //searchBookByTitleRequestDto : String criteria, String keyword, String category, int amount, int pageNumber
    ...
    /* 인기순위(판매순) 상품 조회 */
    @PostMapping("/searchBookByRanking") //searchBookByRankingRequestDto : int amount, int pageNumber
